...
{
    private ILogger<SpellRepository> _logger;
    private InitiativeTrackerDbContext _dbContext;
    private SpellRepository _repository;

    [SetUp]
    public void Setup()
    {
        _logger = Substitute.For<ILogger<SpellRepository>>();
        ...
        _repository = new SpellRepository(_logger, _dbContext);
    }
    ...
    public async Task AddAsync_ValidDto_ShouldAddSpell()
    {
        ...
        result[0].Classes.Should().BeEmpty();
        result[0].Subclasses.Should().BeEmpty();
    ...
    {
        await _repository.AddAsync(CreateSpellCreateDto("Fireball", "Type", true, true, null, null, "Fire."));
        await _repository.AddAsync(CreateSpellCreateDto("Cure Wounds", "Type", true, false, null, ["Cleric"], "Healing."));
    ...
    public async Task UpdateAsync_ExistingName_ShouldUpdateName()
    {
        ...
        await _repository.UpdateAsync(entity.Id, new SpellUpdateDto("Greater Fireball", null, null, null, null, null, null, null, null, null));
    ...
    public async Task UpdateAsync_NullName_ShouldNotChangeName()
    {
        ...
        await _repository.UpdateAsync(entity.Id, new SpellUpdateDto(null, null, null, null, null, null, null, null, null, null));
    ...
    public async Task UpdateAsync_EmptyName_ShouldNotChangeName()
    {
        ...
        await _repository.UpdateAsync(entity.Id, new SpellUpdateDto("", null, null, null, null, null, null, null, null, null));
    ...
    public async Task UpdateAsync_WithVerbalComponent_ShouldUpdate()
    {
        ...
        await _repository.UpdateAsync(entity.Id, new SpellUpdateDto(null, null, true, null, null, null, null, null, null, null));
    ...
    public async Task UpdateAsync_WithSomaticComponent_ShouldUpdate()
    {
        ...
        await _repository.UpdateAsync(entity.Id, new SpellUpdateDto(null, null, null, true, null, null, null, null, null, null));
    ...
    public async Task UpdateAsync_WithMaterialComponent_ShouldUpdate()
    {
        ...
        await _repository.UpdateAsync(entity.Id, new SpellUpdateDto(null, null, null, null, "Some", null, null, null, null, null));
    ...
    public async Task UpdateAsync_WithClass_ShouldUpdateClass()
    {
        ...
        await _repository.UpdateAsync(entity.Id, new SpellUpdateDto(null, null, null, null, null, ["Bard"], null, null, null, null));
    ...
    public async Task UpdateAsync_WithDescription_ShouldUpdateDescription()
    {
        ...
        await _repository.UpdateAsync(entity.Id, new SpellUpdateDto(null, null, null, null, null, null, null, "<p>A brilliant streak flashes.</p>", null, null));
    ...
    public async Task UpdateAsync_WithPrintedCount_ShouldUpdatePrintedCount()
    {
        ...
        await _repository.UpdateAsync(entity.Id, new SpellUpdateDto(null, null, null, null, null, null, null, null, 123, null));
    ...
    public async Task UpdateAsync_WithLink_ShouldUpdateLink()
    {
        ...
        await _repository.UpdateAsync(entity.Id, new SpellUpdateDto(null, null, null, null, null, null, null, null, null, "link"));
    ...
    {
        var act = () => _repository.UpdateAsync(999, new SpellUpdateDto("Name", "Type", true, false, null, null, null, null, null, null));
    ...
    public async Task UpdateAsync_PartialUpdate_ShouldOnlyChangeProvidedFields()
    {
        ...
        await _repository.UpdateAsync(entity.Id, new SpellUpdateDto(null, null, null, null, "Some", ["Sorcerer"], null, null, null, null));
    ...
    {
        await _repository.AddAsync(CreateSpellCreateDto("Fireball", "Type", true, true, null, null, "Fire."));
        await _repository.AddAsync(CreateSpellCreateDto("Fire Shield", "Type", true, true, null, null, "Shield."));
        await _repository.AddAsync(CreateSpellCreateDto("Cure Wounds", "Type", true, false, null, ["Cleric"], "Heal."));

        var result = await _repository.SearchAsync("fire");
    ...
    public async Task SearchAsync_NoMatch_ShouldReturnEmpty()
    {
        ...
        var result = await _repository.SearchAsync("healing");
    ...
    public async Task SearchAsync_CaseInsensitive_ShouldMatch()
    {
        ...
        var result = await _repository.SearchAsync("FIREBALL");
