...
public class MiniatureServiceTests
{
    ...
    public async Task AddAsync_WithImageData_ShouldPersistImage()
    {
        ...
        var dto = new MiniatureCreateDto("Big Red Dragon", CreatureSize.Gargantuan, imageBytes, 12, null, 0, 0, 0, 0, 0, 0);
    ...
    public async Task UpdateAsync_ExistingName_ShouldUpdateName()
    {
        ...
        await _service.UpdateAsync(entity.Id, new MiniatureUpdateDto("New Goblin", null, null, null, 0, 0, 0, 0, 0, 0));
    ...
    public async Task UpdateAsync_NullName_ShouldNotChangeName()
    {
        ...
        await _service.UpdateAsync(entity.Id, new MiniatureUpdateDto(null, null, null, null, 0, 0, 0, 0, 0, 0));
    ...
    public async Task UpdateAsync_WithSize_ShouldUpdateSize()
    {
        ...
        await _service.UpdateAsync(entity.Id, new MiniatureUpdateDto(null, CreatureSize.Medium, null, null, 0, 0, 0, 0, 0, 0));
    ...
    public async Task UpdateAsync_WithPrintedCount_ShouldUpdatePrintedCount()
    {
        ...
        await _service.UpdateAsync(entity.Id, new MiniatureUpdateDto(null, null, 5, null, 0, 0, 0, 0, 0, 0));
    ...
    public async Task UpdateAsync_WithLink_ShouldUpdateLink()
    {
        ...
        await _service.UpdateAsync(entity.Id, new MiniatureUpdateDto(null, null, null, "link", 0, 0, 0, 0, 0, 0));
    ...
    {
        var act = () => _service.UpdateAsync(999, new MiniatureUpdateDto("Name", CreatureSize.Small, null, null, 0, 0, 0, 0, 0, 0));
    ...
    static MiniatureCreateDto CreateMiniatureCreateDto(
        ...
        int printedCount = 0,
        string? link = null) =>
        new(name, size, [], printedCount, link, 0, 0, 0, 0, 0, 0);
}
